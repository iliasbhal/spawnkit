...
describe("Instance", () => {
  ...
  const instances = {
    ...
    withInvokeResolved: MachineActorInstance.from(withInvokeResolved),
    withInvokeRejected: MachineActorInstance.from(withInvokeRejected),
    withDelayedInvoke: MachineActorInstance.from(withDelayedInvoke),
  };
